...
// aplica o conteudo das outras classe na security
...
public class BasicSecurityConfig {
	...
	@Bean
	SecurityFilterChain filterChaim(HttpSecurity http) throws Exception {

		http.sessionManagement(menagement -> menagement.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
